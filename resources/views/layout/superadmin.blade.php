        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ url('management_user') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/jurusan') }}" class="nav-link pl-6">
                                        <i class="fas fa-book-reader nav-icon"></i>
                                        <p>Jurusan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/baju') }}" class="nav-link">
                                        <i class="fas fa-tshirt nav-icon"></i>
                                        <p>Baju</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/info') }}" class="nav-link">
                                        <i class="fa fa-sticky-note nav-icon"></i>
                                        <p>Informasi SPMB</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/jalur') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/undangan') }}" class="nav-link pl-6">
                                        <i class="fas fa-envelope-open nav-icon"></i>
                                        <p>Jalur Undangan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/prestasi') }}" class="nav-link pl-6">
                                        <i class="fas fa-award nav-icon"></i>
                                        <p>Jalur Prestasi</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/reguler') }}" class="nav-link pl-6">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/pembayaran/undangan') }}" class="nav-link pl-6">
                                        <i class="fas fa-envelope-open nav-icon"></i>
                                        <p>Jalur Undangan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/pembayaran/prestasi') }}" class="nav-link pl-6">
                                        <i class="fas fa-award nav-icon"></i>
                                        <p>Jalur Prestasi</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('superadmin/pembayaran/reguler') }}" class="nav-link pl-6">
                                        <i class="far fa-file-alt nav-icon"></i>
                                        <p>Jalur Reguler</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('superadmin/siswa') }}" class="nav-link pl-6">
                                <i class="fas fa-user-friends nav-icon"></i>
                                <p>Data Siswa</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('superadmin/orangtua') }}" class="nav-link pl-6">
                                <i class="fas fa-user-friends nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Halo, {{ auth()->user()->name }}
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
