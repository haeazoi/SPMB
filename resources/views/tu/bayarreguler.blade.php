                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-center">
                                <h4>Pembayaran Jalur Reguler</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <td>
                                            @if ($bayar->bukti_pembayaran)
                                                <a href="{{ asset('storage/' . $bayar->bukti_pembayaran) }}"
                                                    target="_blank"><i class="fas fa-eye"></i> Bukti Pembayaran</a>
                                            @else
                                                ...
                                                <td style="padding: 25px">
                                                    @if ($b->bukti_pembayaran)
                                                        @if ($b->status_bayar != 'Lunas')
                                                            <form
                                                                action="{{ route('pembayaran.reguler.update', $b->pendaftar->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                            ...
                                                            <br>
                                                            <form
                                                                action="{{ route('pembayaran.reguler.reject', $b->pendaftar->id) }}"
                                                                method="POST">
                                                                @csrf
