                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-center">
                                <h4>Pembayaran Jalur Prestasi</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                                ...
                                                <td style="padding: 25px">
                                                    @if ($b->bukti_pembayaran)
                                                        @if ($b->status_bayar != 'Lunas')
                                                            <form
                                                                action="{{ route('pembayaran.prestasi.update', $b->pendaftar->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                            ...
                                                            <br>
                                                            <form
                                                                action="{{ route('pembayaran.prestasi.reject', $b->pendaftar->id) }}"
                                                                method="POST">
                                                                @csrf
