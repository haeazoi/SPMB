...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-center">
                                <h4>Seleksi Pendaftaran Prestasi</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            ...
                                            @elseif ($daftar->status_berkas == 'Ditolak')
                                                <span class="badge badge-danger">{{ $daftar->status_berkas }}</span><br>Alasan: {{ $daftar->alasan }}
                                            @endif
                                        </td>
    ...
    @foreach ($pendaftar as $d)
        <div class="modal fade" id="DetailSiswa{{ $d->id }}" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @if ($d->status_berkas == 'Menunggu')
                            <form action="{{ url('prestasi/' . $d->id . '/Terverifikasi') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-success btn-sm Veriv">Lulus </button>
                            </form>
                            <form action="{{ url('prestasi/' . $d->id . '/Ditolak') }}" method="POST">
                                @csrf
